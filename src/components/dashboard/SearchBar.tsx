...
const SearchBar: FC = () => {
  return (
    ...
    >
        ...
        <CustomText variant='h6' fontFamily={Fonts.Medium}>Search for atta, dal, coke</CustomText>
        <CustomText variant='h6' fontFamily={Fonts.Medium}>Search "chips"</CustomText>
        <CustomText variant='h6' fontFamily={Fonts.Medium}>Search "patato tomato"</CustomText>
        <CustomText variant='h6' fontFamily={Fonts.Medium}>Search "masala"</CustomText>
