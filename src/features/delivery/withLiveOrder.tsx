    ...
    if (currentOrder) {
      const watchId = Geolocation.watchPosition(
        async (position) => {
          ...
          console.log("LIVE TRACKING 🟢", " LAT: ", new Date().toLocaleTimeString(), latitude.toFixed, longitude.toFixed)
      ...
      {currentOrder && (
        <View style={[hocStyles.cartContainer, { flexDirection: 'row', alignItems: 'center', paddingHorizontal:20}]}>
          <View style={styles.flexRow}>
            ...
            <TouchableOpacity onPress={() => navigate('DeliveryMap', { ...currentOrder })} style={styles.btn}>
